...
export function getNews(categoryName){
    return function(dispatch){
        let url = `https://newsapi.org/v2/top-headlines?sources=the-new-york-times,cnn,the-wall-street-journal,abc-news,fox-news,cbs-news,&apiKey=72eb57002bca4d42a85404eef1e97d2a&pageSize=100`;
        if(categoryName){
